package com.zoho.payments.param.virtualaccount;
...
// Body for {@code PUT /virtualaccounts/{virtual_account_id}}.
public final class VirtualAccountUpdateParams
{
	...
	public static final class Builder
	{
		...
		{
			if (description == null && minimumAmount == null && maximumAmount == null
					&& expiresAt == null && referenceNumber == null && metaData == null)
			{
				throw new IllegalArgumentException(
						"At least one field must be set for virtual account update"); //No I18N
			}
